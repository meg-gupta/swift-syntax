...
@_spi(RawSyntax)
public struct RawLifetimeDependenceSpecifierSyntax: RawSyntaxNodeProtocol {
  @_spi(RawSyntax)
  public var layoutView: RawSyntaxLayoutView {
    return raw.layoutView!
  }
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    return raw.kind == .lifetimeDependenceSpecifier
  }
  ...
  public init(_ unexpected: RawUnexpectedNodesSyntax? = nil, arena: __shared SyntaxArena) {
    let raw = RawSyntax.makeLayout(
      kind: .lifetimeDependenceSpecifier, uninitializedCount: 1, arena: arena) { layout in
      layout.initialize(repeating: nil)
...
@_spi(RawSyntax)
public struct RawLifetimeDependentReturnTypeSyntax: RawTypeSyntaxNodeProtocol {
  @_spi(RawSyntax)
  public var layoutView: RawSyntaxLayoutView {
    return raw.layoutView!
  }
  ...
  public static func isKindOf(_ raw: RawSyntax) -> Bool {
    return raw.kind == .lifetimeDependentReturnType
  }
  ...
  public init(
      _ unexpectedBeforeLifetimeDependenceSpecifier: RawUnexpectedNodesSyntax? = nil, 
    ...
    let raw = RawSyntax.makeLayout(
      kind: .lifetimeDependentReturnType, uninitializedCount: 5, arena: arena) { layout in
      layout.initialize(repeating: nil)
      layout[0] = unexpectedBeforeLifetimeDependenceSpecifier?.raw
      layout[1] = lifetimeDependenceSpecifier.raw
      layout[2] = unexpectedBetweenLifetimeDependenceSpecifierAndType?.raw
      layout[3] = type.raw
  ...
  public var unexpectedBeforeLifetimeDependenceSpecifier: RawUnexpectedNodesSyntax? {
    layoutView.children[0].map(RawUnexpectedNodesSyntax.init(raw:))
  }
  
  public var lifetimeDependenceSpecifier: RawLifetimeDependenceSpecifierSyntax {
    layoutView.children[1].map(RawLifetimeDependenceSpecifierSyntax.init(raw:))!
  }
